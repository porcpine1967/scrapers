...
""".format(
            title=self.title, css=self.css, author=self.author
        )
...
class Font(object):
    ...
    @property
    def css_style(self):
        return "font-family:{};font-size:{}%;color:{};".format(
            self.family, self.size_pct, self.color
        )
